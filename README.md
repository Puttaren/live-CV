...
3. **Verksamhetsstyrning och visualisering (Power BI):** 
![Dashboard](dashboard.jpg)
Slutprojektet i kursen "BI-verktyg och verksamhetsprocesser" fokuserade på att transformera komplexa affärsbehov till en interaktiv analyslösning. Efter 30 år som skribent innebar detta projekt en framgångsrik övergång till teknisk datamodellering och visualisering, vilket resulterade i en integrerad dashboard för fyra affärsområden:
